...
def render_sentiment(database):
    ...
    # Ajout du bouton "Lancer Clients vs Entreprise"
    if st.button("Lancer Clients vs Entreprise"):
        entreprise_vs_clients(selected_company.split(' (')[0])  # Appel avec le nom de l'entreprise
